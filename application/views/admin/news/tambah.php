            ...
            <div class="card-body">
                <form action="<?= base_url('admin/news/add') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('judul')?'is-invalid':'' ?>" name="judul" placeholder="Judul News">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="file" accept="image/*" class="form-control-file <?= form_error('gambar')?'is-invalid':'' ?>" name="gambar">
                        <div class="invalid-feedback">
                            <?= form_error('gambar') ?>
                        </div>
                    </div>
